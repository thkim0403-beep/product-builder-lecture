...
Wrongs: ${q.incorrect_answers.join(', ')}`;
            ...
            2. **완벽한 한국어**: 보기(정답 및 오답)에 **영어 알파벳을 절대 포함하지 마세요**. 외래어는 반드시 한글로 표기하세요. (예: 'Apple' -> '애플', 'BTS' -> '방탄소년단')
            3. **매력적인 오답**: 정답과 전혀 상관없는 엉뚱한 단어 대신, **정답과 헷갈릴 수 있는 그럴듯한 오답**을 배치하세요.
            4. **형식 준수**: 문제|정답|오답1|오답2|오답3 (정확히 10줄)

            [나쁜 예시]
            Q: 이순신이 사용한 배는?
            A: Turtle Ship|Panokseon|Warship|Boat (X - 영어 사용 금지)

            [좋은 예시]
            Q: 임진왜란 당시 거북선을 이끌고 왜군을 물리친 조선의 명장, '성웅'이라 불리는 이 사람은 누구일까요?
            A: 이순신|강감찬|을지문덕|권율 (O - 전원 한글)`;
            ...
            if (lang === 'en') {
                ...
                [절대 규칙]
                1. 언어: **원어민 수준의 완벽하고 자연스러운 한국어**만 사용하세요.
                2. **영어 금지**: 보기(정답/오답)에 영어가 섞여 나오면 절대 안 됩니다. 반드시 **한글**로만 작성하세요. (DNA -> 디엔에이, TV -> 텔레비전)
                3. 문체: 친근하고 정중한 '해요체' (~인가요? ~은 무엇일까요?)
                ...
                Q: 대한민국의 수도는?
                A: Seoul|Busan|Incheon|Daegu (X - 절대 금지!) -> 서울|부산|인천|대구 (O)`;
