...
Wrongs: ${q.incorrect_answers.join(', ')}`;
            ...
            [좋은 예시]
            Q: 맨유의 전설적인 공격수는?
            A: 웨인 루니|호날두|메시|박지성 (O - 사람 이름 한글 표기)
            Q: 유전 정보를 담고 있는 물질은?
            A: DNA|RNA|단백질|세포 (O - 약어는 영어 허용)`;
            ...
            if (lang === 'en') {
                ...
                [예시]
                Q: 영국의 축구 스타 웨인 루니가 뛰었던 팀은?
                A: 맨체스터 유나이티드|리버풀|첼시|아스날 (O - 팀명 한글)
                
                Q: 우리 몸의 설계도라 불리는 것은?
                A: DNA|RNA|혈액|근육 (O - 약어 허용)
                
                Q: 유명한 물리학자는?
                A: Newton|Curie|Edison|Tesla (X - 이름 영어 금지) -> 뉴턴|퀴리|에디슨|테슬라 (O)`;
